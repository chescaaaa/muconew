			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2 text-center">
					<div class="section-title">	
						...
						<p>"Our cooperative are built to empower your projects, offering reliable solutions for all your building needs."</p>
					</div>
				</div>
			</div>
            ...
            <div class="col-lg-4 col-md-6 text-center">
                <div class="single-product-item">
                    <div class="product-image">
                        <a href="single-product.html"><img src="/uploads/<?= $product['ImageURL']; ?>" alt="" width= "200px" height= "150px" object-fit= "cover";></a>
                    </div>
                    <h3><?= $product['ProductName']; ?></h3>
                    <p class="product-price"><span>Per</span>₱<?= $product['Price']; ?></p>
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-12">
					<div class="abt-text">
						...
						<p>Discover MUCOFACO, your go-to source for top-notch building materials and tools, ensuring smooth and successful projects every time.</p>
						<p>Explore our wide range of products tailored to meet your construction needs and achieve exceptional results.</p>
			...
			<div class="row">
				<div class="col-lg-3 col-md-6">
					<div class="footer-box about-widget">
						...
						<p>At MUCOFACO, we are committed to providing superior quality building materials and tools to empower construction projects of all sizes. With a dedication to excellence and customer satisfaction, we strive to be your trusted partner in achieving outstanding results.</p>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">
