						    ...
						    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
						      <div class="card-body">
								...
								<form action="/place-order" method="POST">
									<?= csrf_field() ?>
									<p><input type="text" name="name" placeholder="Name" value="<?= esc($user['FirstName']) . ' ' . esc($user['LastName']) ?>" disabled></p>
									<p><input type="email" name="email" placeholder="Email" value="<?= esc($user['Email']) ?>" disabled></p>
									<p><input type="text" name="address" placeholder="Address" value="<?= esc($user['Sitio']), ', ', esc($user['Barangay']), ', ',  esc($user['Municipality']) ?>" disabled></p>
									<p><input type="tel" name="phone" placeholder="Phone" value="<?= esc($user['Phone']) ?>" disabled></p>
									<p><textarea name="comments" id="comments" cols="30" rows="5" placeholder="Comments"></textarea></p>
								</form>
						        </div>
						      </div>
						    </div>
