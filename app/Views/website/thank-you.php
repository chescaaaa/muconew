                ...
                <div class="col-lg-4 col-md-6 text-center">
                    <div class="single-product-item">
                        <div class="product-image">
                            <img src="uploads/<?= $detail['ImageURL']; ?>" alt="<?= $detail['ProductName']; ?>" width="200px" height="150px" object-fit="cover">
                        </div>
                        <h3><?= $detail['ProductName']; ?></h3>
                        <p class="product-price"><span>Price: </span>₱ <?= $detail['Price']; ?></p>
                        <p class="product-quantity"><span>Quantity:</span> <?= $detail['Quantity']; ?> </p>
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
    </div>
    <!-- End Products Purchased Section -->
