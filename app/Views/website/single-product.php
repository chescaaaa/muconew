			...
			<div class="row">
				<div class="col-lg-12 col-sm-12 text-center">
					<div class="main-menu-wrap">
						<!-- logo -->
						<div class="site-logo">
							<a href="<?= base_url() ?>"> <!-- Replace 'index.html' with your home route -->
						...
						<nav class="main-menu">
							<ul>
								<li class="current-list-item">
									<a href="<?= site_url() ?>">Home</a> <!-- Replace 'index.html' with your home route -->
									<ul class="sub-menu">
										<li><a href="<?= site_url('static-home') ?>">Static Home</a></li> <!-- Replace 'index.html' with the appropriate CI4 route -->
										<li><a href="<?= site_url('slider-home') ?>">Slider Home</a></li> <!-- Replace 'index_2.html' with the appropriate CI4 route -->
									</ul>
								</li>
								<!-- Other menu items -->
